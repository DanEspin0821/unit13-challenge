    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                ...
                " We will come up with a plan soon if you would like to invest for your future children, thank you for being proactive in life!"
            )
            ...
            return build_validation_result(
                ...
                " Recommendations for the age will be available in the future. But you will most likely need to continue working past retirement, if you have not saved enough already."
                )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                ...
                " Investment options for small retail investors like yourself are coming soon!"
            )
